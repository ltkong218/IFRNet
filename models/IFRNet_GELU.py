...
class ResBlock(nn.Module):
    def __init__(self, in_channels, side_channels, bias=True):
        ...
        self.conv1 = convrelu(in_channels, in_channels,3,1,1,bias=bias)
        self.conv2 = convrelu(side_channels,side_channels,3,1,1,bias=bias)
        self.conv3 = convrelu(in_channels,in_channels,3,1,1,bias=bias)
        self.conv4 = convrelu(side_channels,side_channels,3,1,1,bias=bias)
    ...
    def forward(self, x):
        ...
        out = self.gelu(x + self.conv5(out))
        return out
